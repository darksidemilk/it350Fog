...
class DashboardPage extends FOGPage
{
	...
	*/
	public function index()
	{
		...
		echo '
		<div class="row">
                <center><h3>ME Fog Custom Inventory</h3>
				    <a href="/fog/management/it350/checkout_view.php"  class="btn btn-default btn-lg active" role="button">Checkout Devices</a>
                    <a href="/fog/management/it350/user_view.php"  class="btn btn-default btn-lg active" role="button">Users</a>
                    <a href="/fog/management/it350/purchase_record_view.php" class="btn btn-default btn-lg active" role="button">Purchase Records</a>
				</center>
                <br/>
				<br/> 
        </div>';
