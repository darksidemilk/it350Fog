...
if(isset($_GET['lastname'])){
    ...
    $id=$row['userId'];
    $query="INSERT INTO Has_phone (usernum,phone) VALUES ($id,'$phone')";
    mysql_query($query, $conn)or die(mysql_error());
    $query="INSERT INTO Has_email (currentuser,email) VALUES ($id,'$email')";
    mysql_query($query, $conn)or die(mysql_error());
}else{
    show_form();
}
            ...
            <form name="user" method="get" action="">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        ...
                        <input id="email" name="email" maxlength="25" type="text">
                    </div>
                </div>
                <br>
                <div class="row">
